...
void toolboxSpriteInit(Simcity* simcity){
    ...
    simcity->toolBox.tabSpriteToolBox[ROUTE_CLIQUE].spriteLargeur = 45;
    simcity->toolBox.tabSpriteToolBox[ROUTE_CLIQUE].spriteHauteur = 45;
    ...
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].image = &simcity->tabBitmap[BITMAP_TOOLBOX];
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].spriteLargeur = 45;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].spriteHauteur = 45;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].spriteX = 82;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].spriteY = 268;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].screenX = 60;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].screenY = 720;

    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].image = &simcity->tabBitmap[BITMAP_TOOLBOX];
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].spriteLargeur = 45;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].spriteHauteur = 45;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].spriteX = 152;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].spriteY = 268;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].screenX = 60;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].screenY = 720;

    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].image = &simcity->tabBitmap[BITMAP_TOOLBOX];
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].spriteLargeur = 35;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].spriteHauteur = 35;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].spriteX = 222;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].spriteY = 268;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].screenX = 60;
    simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].screenY = 720;
    ...
    simcity->toolBox.tabSpriteToolBox[VUE_3].image = &simcity->tabBitmap[BITMAP_TOOLBOX];
    simcity->toolBox.tabSpriteToolBox[VUE_3].spriteLargeur = 35;
    simcity->toolBox.tabSpriteToolBox[VUE_3].spriteHauteur = 35;
    simcity->toolBox.tabSpriteToolBox[VUE_3].spriteX = 14;
    simcity->toolBox.tabSpriteToolBox[VUE_3].spriteY = 165;
    simcity->toolBox.tabSpriteToolBox[VUE_3].screenX = 11;
    simcity->toolBox.tabSpriteToolBox[VUE_3].screenY = 207;

    simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].image = &simcity->tabBitmap[BITMAP_TOOLBOX];
    simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].spriteLargeur = 35;
    simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].spriteHauteur = 35;
    simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].spriteX = 14;
    simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].spriteY = 215;
    simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].screenX = 11;
    simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].screenY = 207;

    simcity->toolBox.tabSpriteToolBox[VUE_3_CLIQUE].image = &simcity->tabBitmap[BITMAP_TOOLBOX];
    simcity->toolBox.tabSpriteToolBox[VUE_3_CLIQUE].spriteLargeur = 35;
    simcity->toolBox.tabSpriteToolBox[VUE_3_CLIQUE].spriteHauteur = 35;
    simcity->toolBox.tabSpriteToolBox[VUE_3_CLIQUE].spriteX = 14;
...
void calculHoverToolBox(Simcity* simcity){
    if ((float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[ROUTE_].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[ROUTE_].screenX + simcity->toolBox.tabSpriteToolBox[ROUTE_].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[ROUTE_].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[ROUTE_].screenY + simcity->toolBox.tabSpriteToolBox[ROUTE_].spriteHauteur ){
        simcity->toolBox.routeHover = 1;
    }else if ((float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[MAISON_].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[MAISON_].screenX + simcity->toolBox.tabSpriteToolBox[MAISON_].spriteLargeur && (float)simcity->allegro.event.mouse.y > simcity->toolBox.tabSpriteToolBox[MAISON_].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[MAISON_].screenY + simcity->toolBox.tabSpriteToolBox[MAISON_].spriteHauteur ){
        simcity->toolBox.maisonHover = 1;
    }else if ((float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[EAU].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[EAU].screenX + simcity->toolBox.tabSpriteToolBox[EAU].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[EAU].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[EAU].screenY + simcity->toolBox.tabSpriteToolBox[EAU].spriteHauteur ){
        simcity->toolBox.eauHover = 1;
    }else if ((float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[ELEC].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[ELEC].screenX + simcity->toolBox.tabSpriteToolBox[ELEC].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[ELEC].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[ELEC].screenY + simcity->toolBox.tabSpriteToolBox[ELEC].spriteHauteur ){
        simcity->toolBox.elecHover = 1;
    }else if ((float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[DETRUIRE].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[DETRUIRE].screenX + simcity->toolBox.tabSpriteToolBox[DETRUIRE].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[DETRUIRE].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[DETRUIRE].screenY + simcity->toolBox.tabSpriteToolBox[DETRUIRE].spriteHauteur ){
        simcity->toolBox.detruireHover = 1;
    }else if ((float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[VUE1].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[VUE1].screenX + simcity->toolBox.tabSpriteToolBox[VUE1].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[VUE1].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[VUE1].screenY + simcity->toolBox.tabSpriteToolBox[VUE1].spriteHauteur ){
        simcity->toolBox.vue1Hover = 1;
    }else if ((float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[VUE2].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[VUE2].screenX + simcity->toolBox.tabSpriteToolBox[VUE2].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[VUE2].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[VUE2].screenY + simcity->toolBox.tabSpriteToolBox[VUE2].spriteHauteur ){
        simcity->toolBox.vue2Hover = 1;
    }else if ((float)simcity->allegro.event.mouse.x >= (float)simcity->toolBox.tabSpriteToolBox[POMPIER].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[POMPIER].screenX + simcity->toolBox.tabSpriteToolBox[POMPIER].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[POMPIER].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[POMPIER].screenY + simcity->toolBox.tabSpriteToolBox[POMPIER].spriteHauteur ){
        simcity->toolBox.pompierHover = 1;
    } else if ((float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[PAUSE].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[PAUSE].screenX + simcity->toolBox.tabSpriteToolBox[PAUSE].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[PAUSE].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[PAUSE].screenY + simcity->toolBox.tabSpriteToolBox[PAUSE].spriteHauteur ){
        simcity->toolBox.pauseHover = 1;
    } else if ((float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].screenX + simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].screenY + simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].spriteHauteur ){
        simcity->toolBox.sauvegarderHover = 1;
    } else if ((float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[VUE_3].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[VUE_3].screenX + simcity->toolBox.tabSpriteToolBox[VUE_3].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[VUE_3].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[VUE_3].screenY + simcity->toolBox.tabSpriteToolBox[VUE_3].spriteHauteur ){
        simcity->toolBox.vue3Hover = 1;
    }else{
        ...
        simcity->toolBox.vue3Hover = 0;
        simcity->toolBox.sauvegarderHover = 0;
...
void detectionCliqueToolBox(Simcity* simcity){
    if (simcity->allegro.event.mouse.button == 1 && (float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[ROUTE_].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[ROUTE_].screenX + simcity->toolBox.tabSpriteToolBox[ROUTE_].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[ROUTE_].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[ROUTE_].screenY + simcity->toolBox.tabSpriteToolBox[ROUTE_].spriteHauteur ){
        simcity->toolBox.routeClique = 1;
        simcity->toolBox.routeEnMain = 1;
    }else if (simcity->allegro.event.mouse.button == 1 && (float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[MAISON_].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[MAISON_].screenX + simcity->toolBox.tabSpriteToolBox[MAISON_].spriteLargeur && (float)simcity->allegro.event.mouse.y > simcity->toolBox.tabSpriteToolBox[MAISON_].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[MAISON_].screenY + simcity->toolBox.tabSpriteToolBox[MAISON_].spriteHauteur ){
        simcity->toolBox.maisonClique = 1;
        simcity->toolBox.terrainVagueEnMain = 1;
    }else if (simcity->allegro.event.mouse.button == 1 && (float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[EAU].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[EAU].screenX + simcity->toolBox.tabSpriteToolBox[EAU].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[EAU].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[EAU].screenY + simcity->toolBox.tabSpriteToolBox[EAU].spriteHauteur ){
        simcity->toolBox.eauClique = 1;
        simcity->toolBox.eauEnMain = 1;
        simcity->toolBox.eauDroit = 1;
    }else if (simcity->allegro.event.mouse.button == 1 && (float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[ELEC].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[ELEC].screenX + simcity->toolBox.tabSpriteToolBox[ELEC].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[ELEC].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[ELEC].screenY + simcity->toolBox.tabSpriteToolBox[ELEC].spriteHauteur ){
        simcity->toolBox.elecClique = 1;
        simcity->toolBox.elecEnMain = 1;
        simcity->toolBox.elecDroit = 1;
    }else if (simcity->allegro.event.mouse.button == 1 && (float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[DETRUIRE].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[DETRUIRE].screenX + simcity->toolBox.tabSpriteToolBox[DETRUIRE].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[DETRUIRE].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[DETRUIRE].screenY + simcity->toolBox.tabSpriteToolBox[DETRUIRE].spriteHauteur ){
        simcity->toolBox.detruireClique = 1;
        simcity->toolBox.detruireEnMain = 1;
    }else if (simcity->allegro.event.mouse.button == 1 && (float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[VUE1].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[VUE1].screenX + simcity->toolBox.tabSpriteToolBox[VUE1].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[VUE1].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[VUE1].screenY + simcity->toolBox.tabSpriteToolBox[VUE1].spriteHauteur ){
        simcity->toolBox.vue1Clique = 1;
        simcity->toolBox.vue1EnMain = 1;
    }else if (simcity->allegro.event.mouse.button == 1 && (float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[VUE2].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[VUE2].screenX + simcity->toolBox.tabSpriteToolBox[VUE2].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[VUE2].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[VUE2].screenY + simcity->toolBox.tabSpriteToolBox[VUE2].spriteHauteur ){
        simcity->toolBox.vue2Clique = 1;
        simcity->toolBox.vue2EnMain = 1;
    }else if (simcity->allegro.event.mouse.button == 1 && (float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[POMPIER].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[POMPIER].screenX + simcity->toolBox.tabSpriteToolBox[POMPIER].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[POMPIER].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[POMPIER].screenY + simcity->toolBox.tabSpriteToolBox[POMPIER].spriteHauteur ){
        simcity->toolBox.pompierClique = 1;
        simcity->toolBox.pompierEnMain = 1;
        simcity->toolBox.pompierDroit = 1;
    }else if (simcity->allegro.event.mouse.button == 1 && (float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[PAUSE].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[PAUSE].screenX + simcity->toolBox.tabSpriteToolBox[PAUSE].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[PAUSE].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[PAUSE].screenY + simcity->toolBox.tabSpriteToolBox[PAUSE].spriteHauteur ){
        simcity->toolBox.pauseClique = 1;
        simcity->toolBox.pauseEnMain = 1;
    }else if (simcity->allegro.event.mouse.button == 1 && (float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].screenX + simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].screenY + simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].spriteHauteur ){
        simcity->toolBox.sauvegarderClique = 1;
      //  simcity->toolBox.sauvegarderEnmain = 1;
    }else if (simcity->allegro.event.mouse.button == 1 && (float)simcity->allegro.event.mouse.x >= simcity->toolBox.tabSpriteToolBox[VUE_3].screenX && (float)simcity->allegro.event.mouse.x <= simcity->toolBox.tabSpriteToolBox[VUE_3].screenX + simcity->toolBox.tabSpriteToolBox[VUE_3].spriteLargeur && (float)simcity->allegro.event.mouse.y >= simcity->toolBox.tabSpriteToolBox[VUE_3].screenY && (float)simcity->allegro.event.mouse.y <= simcity->toolBox.tabSpriteToolBox[VUE_3].screenY + simcity->toolBox.tabSpriteToolBox[VUE_3].spriteHauteur ){
        simcity->toolBox.vue3Clique = 1;
        simcity->toolBox.vue3EnMain = 1;
    }else{
        ...
        simcity->toolBox.vue3Clique = 0;
        simcity->toolBox.sauvegarderClique = 0;
        ...
        //simcity->toolBox.sauvegarderEnmain = 0;
    }
...
void afficherToolbox (Simcity* simcity){
    ...
    al_draw_bitmap_region(*(simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].image),simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].spriteX,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].spriteY,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].spriteLargeur,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].spriteHauteur,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].screenX,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER].screenY,0);
    ...
    }else if (simcity->toolBox.sauvegarderHover){
        al_draw_bitmap_region(*(simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].image),simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].spriteX,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].spriteY,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].spriteLargeur,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].spriteHauteur,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].screenX,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_HOVER].screenY,0);
    ...
    }else if (simcity->toolBox.vue3Hover){
        al_draw_bitmap_region(*(simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].image),simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].spriteX,simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].spriteY,simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].spriteLargeur,simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].spriteHauteur,simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].screenX,simcity->toolBox.tabSpriteToolBox[VUE_3_HOVER].screenY,0);
    ...
    }else if (simcity->toolBox.sauvegarderClique){
        al_draw_bitmap_region(*(simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].image),simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].spriteX,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].spriteY,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].spriteLargeur,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].spriteHauteur,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].screenX - 4,simcity->toolBox.tabSpriteToolBox[SAUVEGARDER_CLIQUE].screenY,0);

    }else if (simcity->toolBox.vue3Clique){
        al_draw_bitmap_region(*(simcity->toolBox.tabSpriteToolBox[VUE_3_CLIQUE].image),simcity->toolBox.tabSpriteToolBox[VUE_3_CLIQUE].spriteX,simcity->toolBox.tabSpriteToolBox[VUE_3_CLIQUE].spriteY,simcity->toolBox.tabSpriteToolBox[VUE_3_CLIQUE].spriteLargeur,simcity->toolBox.tabSpriteToolBox[VUE_3_CLIQUE].spriteHauteur,simcity->toolBox.tabSpriteToolBox[VUE_3_CLIQUE].screenX,simcity->toolBox.tabSpriteToolBox[VUE_3_CLIQUE].screenY,0);
    }
