...
void afficherToolbox (Simcity* simcity){
    ...
    al_draw_textf(simcity->allegro.fonts[1], simcity->allegro.color[BLACK], 28, 305, 0, ": %d", simcity->capaciteElecRestante);
    al_draw_textf(simcity->allegro.fonts[1], simcity->allegro.color[BLACK], 28, 355, 0, ": %d", simcity->capaciteEauRestante);
