...
enum SPRITE_BOITE_A_OUTIL {ROUTE_, ROUTE_HOVER, SAUVEGARDER, SAUVEGARDER_HOVER, SAUVEGARDER_CLIQUE, ROUTE_CLIQUE,MAISON_, MAISON_HOVER, MAISON_CLIQUE,ELEC, ELEC_HOVER, ELEC_CLIQUE, EAU, EAU_HOVER, EAU_CLIQUE, DETRUIRE, DETRUIRE_HOVER, DETRUIRE_CLIQUE, VUE1, VUE1_HOVER, VUE1_CLIQUE,VUE2, VUE2_HOVER, VUE2_CLIQUE, POMPIER, POMPIER_HOVER, POMPIER_CLIQUE, PAUSE, PAUSE_HOVER, PAUSE_CLIQUE, VUE_3, VUE_3_HOVER, VUE_3_CLIQUE,INFO_ELEC, INFO_EAU, NB_SPRITE_TOOL_BOX};
